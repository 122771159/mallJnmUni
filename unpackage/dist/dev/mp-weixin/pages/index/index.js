...
if (!Array) {
  ...
  (_easycom_uv_search2 + _easycom_my_ShopList2 + _easycom_my_tabber2 + _easycom_my_CartFloat2 + _easycom_my_CartShow2 + _easycom_my_CartSummaryBar2 + _easycom_uv_popup2 + _easycom_layout2)();
}
...
if (!Math) {
  (_easycom_uv_search + _easycom_my_ShopList + _easycom_my_tabber + _easycom_my_CartFloat + _easycom_my_CartShow + _easycom_my_CartSummaryBar + _easycom_uv_popup + _easycom_layout)();
}
const _sfc_main = {
  __name: "index",
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        d: common_vendor.sr(popup, "069749a4-5,069749a4-0", {
          "k": "popup"
        }),
        e: common_vendor.p({
          mode: "bottom",
